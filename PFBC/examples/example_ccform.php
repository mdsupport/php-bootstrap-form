...
<?php } ?>
  ...
  <body>
    ...
    Form::Hidden ("id");
    Form::Textbox ("Cardholder name", "nameOnCard", ["minlength" => 4, "required" => 1, "validation" => new AlphaNumeric()]);
    Form::Textbox ("Card number", "cardNum",  ["placeholder" => 'XXXXXXXXXXXXXXXX', "maxlength" => 18, "required" => 1, "pattern" => '\d{16,18}', "validation" => new Numeric()]);
    Form::Select ("Expiration date", "expMonth", $months, Array('required' => 1, 'shared' => "col-xs-6 col-md-4", "validation" => new Numeric()));
    Form::Select ("", "expYear", $years, Array("required" => 1, "shared" => "col-xs-6 col-md-4", "validation" => new Numeric()));
    Form::TextBox ("CVV", "cvNum", Array("required" => 1, "maxlength" => 4, "pattern" => '\d{3,4}', "validation" => new Numeric()));
    ...
    Form::Hidden ("id");
    Form::Textbox ("Name", "nameOnCard", ["minlength" => 4, "required" => 1, "validation" => new AlphaNumeric()]);
    Form::Textbox ("Card Number", "cardNum",  ["placeholder" => 'XXXXXXXXXXXXXXXX', "maxlength" => 18, "required" => 1, "pattern" => '\d{16,18}', "validation" => new Numeric()]);
    Form::Select ("ExpDate", "expMonth", $months, Array('required' => 1, "validation" => new Numeric()));
    Form::Select ("", "expYear", $years, Array("required" => 1, "validation" => new Numeric()));
    Form::TextBox ("CVV", "cvNum", Array("required" => 1, "maxlength" => 4, "pattern" => '\d{3,4}', "validation" => new Numeric()));
    ...
    Form::Textbox ("Cardholder name", "nameOnCard", ["minlength" => 4, "required" => 1, "validation" => new AlphaNumeric()]);
    Form::Textbox ("Card number", "cardNum",  ["placeholder" => 'XXXXXXXXXXXXXXXX', "maxlength" => 18, "required" => 1, "pattern" => '\d{16,18}', "validation" => new Numeric()]);
    Form::Select ("Expiration date", "expMonth", $months, Array('required' => 1, 'shared' => "col-xs-6", "validation" => new Numeric()));
    Form::Select ("", "expYear", $years, Array("required" => 1, "shared" => "col-xs-6", "validation" => new Numeric()));
    Form::TextBox ("CVV", "cvNum", Array("required" => 1, "maxlength" => 4, "pattern" => '\d{3,4}', "validation" => new Numeric()));
    Form::Button ("GO", 'submit', array('class' => 'btn-primary pull-right'));
    $form->close (null);
    echo '<hr>';
